...
#ifndef TCCPPLIB_INCLUDE_PPX_LINALG_HPP_
#define TCCPPLIB_INCLUDE_PPX_LINALG_HPP_
...
namespace ppx
{
	...
	template <size_t M, size_t N>
	enable_when_matrix_t<M, N, double> norm2(const MatrixS<M, N> &mat)
	{
		double res = 0.0;
		for (auto ele : mat)
		{
...
#endif //TCCPPLIB_INCLUDE_PPX_LINALG_HPP_
